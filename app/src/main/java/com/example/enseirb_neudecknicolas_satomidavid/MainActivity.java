...
public class MainActivity extends AppCompatActivity implements
    ...
    private static final int WHO_RUNS_REQUEST_CODE = 1;
    ...
    private Button seePreviousRuns;
    private Button change_runner;
    ...
    private final ServiceConnection mServiceConnection = new ServiceConnection() {
        ...
        public void onServiceConnected(ComponentName name, IBinder service) {
            ...
            if(mService.getUser() == null){
                ...
                runner.setText("Current Runner: " + user.getFirst_name() + " " + user.getLast_name());
                double distance_nice = mService.getDistance_so_far();
                distance_nice -= distance_nice % 0.01;
                distance_nice *= 100d;
                distance_nice = ((int) distance_nice) / 100d;
                informations.setText("Distance so far: " + distance_nice + "m");
            }
            mBound = true;
        }
    ...
    protected void onStart() {
        ...
        seePreviousRuns = findViewById(R.id.see_previous_runs);
        change_runner = findViewById(R.id.change_runner);
        runner = findViewById(R.id.runner);
        informations = findViewById(R.id.main_informations);
        informations.setText("");
        runner.setText("Current Runner: " + user.getFirst_name() + " " + user.getLast_name());

        change_runner.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent i = new Intent(MainActivity.this, WhoRunsActivity.class);
                startActivityForResult(i, WHO_RUNS_REQUEST_CODE);
            }
        });
            ...
            public void onClick(View view) {
                if (!checkPermissions()) {
                    ...
                    if (!manager.isProviderEnabled( LocationManager.GPS_PROVIDER)) {
                        ...
                        informations.setText("Distance so far: 0.0m");
                    }
                }
            }
        });
        ...
        seePreviousRuns.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
    ...
    private void setButtonsState(boolean requestingLocationUpdates) {
        if (requestingLocationUpdates) {
            ...
            change_runner.setEnabled(false);
            mRemoveLocationUpdatesButton.setEnabled(true);
        } else {
            mRequestLocationUpdatesButton.setEnabled(true);
            change_runner.setEnabled(true);
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == WHO_RUNS_REQUEST_CODE) {
